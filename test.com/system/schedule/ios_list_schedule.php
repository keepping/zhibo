...
class ios_list_schedule implements schedule {
	...
	public function exec($data){
		...
		require_once(APP_ROOT_PATH. 'system/umeng/notification/ios/IOSListcast.php');
		...
		try {
			...
			$listcast->setCustomizedField("room_id",  $data['room_id']);
