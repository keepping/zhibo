	...
	public function load($param)
	{
		...
		if($nav_list === false)
		{
			...
			foreach ($nav_list as $k=>$v)
			{
				...
				}elseif(app_conf("INVEST_STATUS")==3){
					//关闭“产品”和“股权”众筹

 					if($v['u_module']!="deals" || $v['u_action']=="house" || $v['u_action']=="gently"){
						$nav_list_item[$k]=$v;
					}
				}

				if($v['u_module']=='index'&&($v['u_action']==''||$v['u_action']=='index')){
					$nav_list_item[$k]['u_action'] =  DEFAULT_ACTION_NAME;
				}
			}
