...
class JubaoAlisdk_payment implements payment {
	...
	public function get_payment_code($payment_notice_id)
	{
		...
		$remark=$subject;
		$returnURL=SITE_DOMAIN . '/callback/payment/jubaoaliapp_response.php';    // 可在商户后台设置
		$callBackURL=SITE_DOMAIN . '/callback/payment/jubaoaliapp_notify.php';  // 可在商户后台设置
		$goodsName=$subject;
		//////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//
		$pay['sdk_code'] = array("pay_sdk_type"=>"JubaoAlisdk","config"=>
			array(
			    "partnerid"=>$partnerid,
                "playerid"=>$playerid,
                "goodsname"=>$goodsName,
	...
	{
        $payment           = $GLOBALS['db']->getRow("select id,config from " . DB_PREFIX . "payment where class_name='JubaoAlisdk'");
