...
(function (webim) {
    ...
    Msg.Elem.GroupTip = function (opType, opUserId, groupId, groupName, userIdList, memberInfo) {
        this.opType = opType;//操作类型
        this.opUserId = opUserId;//操作者id
        this.opUserInfo = null;//操作者 info
        ...
        this.opUserInfo = new Msg.Elem.GroupTip.UserInfo(memberInfo.User_Account, memberInfo.NickName);
    };
    ...
    Msg.Elem.GroupTip.prototype.addUserInfo = function (userInfo) {
    ...
    Msg.Elem.GroupTip.prototype.getOpUserInfo = function () {
    ...
    Msg.Elem.GroupTip.prototype.getUserInfoList = function () {
        return this.userInfoList;
    };
    Msg.Elem.GroupTip.prototype.getMemberExtraInfo = function () {
    ...
    Msg.Elem.GroupTip.UserInfo = function (userId, nickname) {
        this.userId = userId;//群成员id
        this.nickname = nickname;
    };
    Msg.Elem.GroupTip.UserInfo.prototype.getUserId = function () {
        return this.userId;
    };
    Msg.Elem.GroupTip.UserInfo.prototype.getNickname = function () {
                ...
                switch (msgType) {
                    ...
                    case MSG_ELEMENT_TYPE.GROUP_TIP:
                        ...
                        msgContent = new Msg.Elem.GroupTip(
                            ...
                            msgBody.MsgContent.MsgOperatorMemberExtraInfo
                        );
                          
                        //加群或退群时，设置最新群成员数
                        if (GROUP_TIP_TYPE.JOIN == opType) {
                            msgContent.setGroupMemberNum(msgBody.MsgContent.MemberNum);
                            var memberInfos = msgBody.MsgContent.MsgMemberExtraInfo;
                            for (var n in memberInfos) {
                                var memberInfo = memberInfos[n];
                                msgContent.addUserInfo(
                                    new Msg.Elem.GroupTip.UserInfo(
                                        memberInfo.User_Account, memberInfo.NickName
                                    )
                                );
                            }
                        } else if (GROUP_TIP_TYPE.QUIT == opType) {
                            msgContent.setGroupMemberNum(msgBody.MsgContent.MemberNum);
