DateInput = (function($) {
	...
	DateInput.prototype = {
		...
		show: function() {
			...
			this.rootLayers.addClass("foucs");
		...
		hide: function() {
			...
			this.rootLayers.removeClass("foucs");
		...
		insideSelector: function(event) {
			var totop=this.dateSelector.offset().top;
			var toleft=this.dateSelector.offset().left;
			var top=totop;
			var bottom=totop +60;
			var left=toleft;
			var right=toleft+ this.dateSelector.outerWidth();
			return event.pageY < bottom && event.pageY > top && event.pageX < right && event.pageX > left
		},
