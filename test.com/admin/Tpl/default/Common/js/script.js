	...
	$(".opration").live('click',function(e){
		...
		if(has_operat_panel){
			...
			if(opration_offset_bottom>250){
				var $ele = '<div class="operat_panel" style="position:absolute;top:20px;right:0;z-index:9999;">'+html_operat_panel+'</div>';
			
			}else{
				var $ele = '<div class="operat_panel" style="position:absolute;bottom:20px;right:0;z-index:9999;">'+html_operat_panel+'</div>';
			}
			$obj.append($ele);
			$obj.addClass("cur");
