...
class UserQickAction extends CommonAction{
   ...
   public function __construct()
	...
	public function index()
	{
		...
		if(intval($_REQUEST['identify_name'])>0)
		{
			$map[DB_PREFIX.'user.identify_name'] = intval($_REQUEST['identify_name']);
		}	
		
		if(intval($_REQUEST['identify_number'])>0)
		{
			$map[DB_PREFIX.'user.identify_number'] = intval($_REQUEST['identify_number']);
		}
		
		//$map[DB_PREFIX.'user.investor_status'] = 0;
